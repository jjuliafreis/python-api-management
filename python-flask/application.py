...
class Product(db.Model):
    id = db.Column(db.Integer, primary_key=True) # Inteiro 1 e chave primária para não ter repetição no id
    name = db.Column(db.String(120), nullable=False) # String texto com tamanho máximo de 120 caracteres e não pode ser nulo o nome
    price = db.Column(db.Float, nullable=False) # Float para números que não sejam inteiros 1,99
    description = db.Column(db.Text, nullable=True) # Text para textos sem limite de caracteres e pode ser nulo.
